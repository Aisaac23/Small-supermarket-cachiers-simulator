...
//To use the java.util.Queue interface uncomment the following lines:
/*
...
public class SuperMarket extends Thread {
    ...
    // To use the java.util.Queue interface replace with: private final Queue<Integer>[] lines; 
                ...
                try 
                {
                    ...
                    for (int i = 0; i < this.Ncashiers; i++)
                        if(!lines[i].isEmpty())
                        {
                            ...
                            this.lines[i].displayQueue();// To use the java.util.Queue interface replace with: System.out.println( Arrays.toString( this.lines[i].toArray() ) );
                        }
                    System.out.println("");
